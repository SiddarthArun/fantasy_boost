...
function renderAppleCard(player, index, theme) {
    ...
    return `
        <article class="animate-fade-in apple-glass rounded-3xl p-6 relative overflow-hidden flex flex-col justify-between group"
                 style="animation-delay: ${animationDelay}ms;">
            
            <!-- Top row: Rank & Points -->
            <div class="flex items-center justify-between mb-5">
                <span class="font-bold text-lg tabular px-3 py-1 rounded-xl bg-white/5 border border-white/10"
                ...
                <div class="text-right">
                    ...
                    <div class="text-[10px] uppercase tracking-[0.2em] text-[#86868b] font-medium mt-1">
                        Est. Points
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center gap-5">
                <div class="relative flex-shrink-0">
                    ...
                    <img src="${player.headshot_url}"
                         alt="${name}"
                         loading="lazy"
                         class="relative w-20 h-20 sm:w-24 sm:h-24 rounded-2xl object-cover bg-neutral-900 border border-white/10 shadow-lg group-hover:scale-105 transition-transform duration-300"
...
window.makeAppleFallback = function(initials, color) {
    ...
    div.className = 'relative w-20 h-20 sm:w-24 sm:h-24 rounded-2xl bg-neutral-900 border border-white/10 flex items-center justify-center font-bold text-2xl text-neutral-300 shadow-lg';
